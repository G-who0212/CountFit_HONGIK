...
# cfg.TEST.MODEL_FILE
    if cfg.TEST.MODEL_FILE:
        # print('=> loading model from {}'.format('/Users/gwho/Desktop/CountFit/AI/demo/pose_hrnet_w32_384x288.pth'))
        # pose_model.load_state_dict(torch.load('/Users/gwho/Desktop/CountFit/AI/demo/pose_hrnet_w32_384x288.pth', map_location=torch.device('cpu')), strict=False)
        
        # ordinary
        # current_dir = os.path.dirname(__file__)
        # relative_path = os.path.join(current_dir, 'pose_hrnet_w32_384x288.pth')
        # pose_model.load_state_dict(torch.load(relative_path, map_location=torch.device('cpu')), strict=False)
        # ordinary

        # test
        pose_model.load_state_dict(torch.load(local_file_path, map_location=torch.device('cpu')), strict=False)
        # test
